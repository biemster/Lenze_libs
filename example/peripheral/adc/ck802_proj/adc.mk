...
Objects0=$(IntermediateDirectory)/ck802_board_init$(ObjectSuffix) $(IntermediateDirectory)/ck802_startup$(ObjectSuffix) $(IntermediateDirectory)/ck802_system$(ObjectSuffix) $(IntermediateDirectory)/ck802_trap_c$(ObjectSuffix) $(IntermediateDirectory)/ck802_vectors$(ObjectSuffix) $(IntermediateDirectory)/misc_jump_table$(ObjectSuffix) $(IntermediateDirectory)/source_clock$(ObjectSuffix) $(IntermediateDirectory)/source_my_printf$(ObjectSuffix) $(IntermediateDirectory)/source_pwrmgr$(ObjectSuffix) $(IntermediateDirectory)/source_watchdog$(ObjectSuffix) \
	$(IntermediateDirectory)/source_adc$(ObjectSuffix) $(IntermediateDirectory)/source_flash$(ObjectSuffix) $(IntermediateDirectory)/source_main$(ObjectSuffix) $(IntermediateDirectory)/source_adc_demo$(ObjectSuffix) $(IntermediateDirectory)/source_adc_Main$(ObjectSuffix) $(IntermediateDirectory)/source_OSAL_adc$(ObjectSuffix) $(IntermediateDirectory)/__rt_entry$(ObjectSuffix) 
...
$(IntermediateDirectory)/source_adc$(ObjectSuffix): ../../../../components/driver/source/adc.c  Lst/source_adc$(PreprocessSuffix)
	$(CC) $(SourceSwitch) ../../../../components/driver/source/adc.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_adc$(ObjectSuffix) -MF$(IntermediateDirectory)/source_adc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_adc$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_adc$(PreprocessSuffix): ../../../../components/driver/source/adc.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_adc$(PreprocessSuffix) ../../../../components/driver/source/adc.c
...
$(IntermediateDirectory)/source_adc_demo$(ObjectSuffix): ../source/adc_demo.c  Lst/source_adc_demo$(PreprocessSuffix)
	$(CC) $(SourceSwitch) ../source/adc_demo.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_adc_demo$(ObjectSuffix) -MF$(IntermediateDirectory)/source_adc_demo$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_adc_demo$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_adc_demo$(PreprocessSuffix): ../source/adc_demo.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_adc_demo$(PreprocessSuffix) ../source/adc_demo.c

$(IntermediateDirectory)/source_adc_Main$(ObjectSuffix): ../source/adc_Main.c  Lst/source_adc_Main$(PreprocessSuffix)
	$(CC) $(SourceSwitch) ../source/adc_Main.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_adc_Main$(ObjectSuffix) -MF$(IntermediateDirectory)/source_adc_Main$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_adc_Main$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_adc_Main$(PreprocessSuffix): ../source/adc_Main.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_adc_Main$(PreprocessSuffix) ../source/adc_Main.c

$(IntermediateDirectory)/source_OSAL_adc$(ObjectSuffix): ../source/OSAL_adc.c  Lst/source_OSAL_adc$(PreprocessSuffix)
	$(CC) $(SourceSwitch) ../source/OSAL_adc.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/source_OSAL_adc$(ObjectSuffix) -MF$(IntermediateDirectory)/source_OSAL_adc$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/source_OSAL_adc$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/source_OSAL_adc$(PreprocessSuffix): ../source/OSAL_adc.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/source_OSAL_adc$(PreprocessSuffix) ../source/OSAL_adc.c
