...
# 52 "../../../../components/inc/global_config.h" 2
...
# 50 "../source/adc_demo.c" 2
# 1 "../../../../components/driver/include/log.h" 1
# 51 "../source/adc_demo.c" 2
...
# 52 "../source/adc_demo.c" 2
# 80 "../source/adc_demo.c"
static uint8 adcDemo_TaskID;
# 95 "../source/adc_demo.c"
adc_Cfg_t adc_cfg =
{
 .channel = (1<<ADC_CH3P_P20)|(1<<ADC_CH3N_P15)|(1<<ADC_CH2P_P14)|(1<<ADC_CH2N_P24)|(1<<ADC_CH1P_P23)|(1<<ADC_CH1N_P11),
...
uint16 adc_ProcessEvent( uint8 task_id, uint16 events )
{
    ...
    if ( events & 0x8000 )
    {
        ...
        if ( (pMsg = _symrom_osal_msg_receive( adcDemo_TaskID )) != 0 )
        {
            adc_ProcessOSALMsg( (osal_event_hdr_t*)pMsg );
            (void) _symrom_osal_msg_deallocate( pMsg );
        }
...
# 170 "../source/adc_demo.c" 3 4
_Bool 
# 170 "../source/adc_demo.c"
     is_high_resolution = 0;
 
# 171 "../source/adc_demo.c" 3 4
_Bool 
# 171 "../source/adc_demo.c"
     is_differential_mode = 0;
 uint8_t ch = 0;
 static uint8_t coutner = 0;

 is_high_resolution = (adc_cfg.is_high_resolution & (1ul << (pev->ch)))?1:0;
 is_differential_mode = (adc_cfg.is_differential_mode & (1ul << (pev->ch)))?1:0;
 ...
 if(ch!=0)
 {
  dbg_printf("P%d %d mv ",ch,(int)(value*1000));
 }
 else
 {
  dbg_printf("invalid channel\n");
 }
 coutner++;
 if(coutner>=6)
 {
...
# 229 "../source/adc_demo.c" 3 4
_Bool 
# 229 "../source/adc_demo.c"
     batt_mode = 1;
 ...
 {
  if((((1ul << (batt_ch)) & adc_cfg.channel) == 0) || adc_cfg.is_differential_mode)
  {
   dbg_printf("Error config parameter!\n");
   return;
  }
 ...
 hal_adc_start();
 if(adc_cfg.is_continue_mode == 0)
 {
  _symrom_osal_start_timerEx(adcDemo_TaskID, 0x0080,1000);
 }
}
