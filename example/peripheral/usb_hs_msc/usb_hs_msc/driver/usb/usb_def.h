...
#define OTG_HCD_TX_FIFO                              (OTG_PCD_IN_FIFO_BASE)
#define OTG_HCD_RX_FIFO                              (OTG_PCD_OUT_FIFO_BASE)
...
typedef union{
	uint32_t d32;
	struct{
		uint32_t STATUS_INT_STS    : 1;
		uint32_t ABOVE_THD_INT_STS : 1;
		uint32_t BELOW_THD_INT_STS : 1;
		uint32_t SOF_DUE_INT_STS   : 1;
		uint32_t RSVD              : 4;
		uint32_t PORT_INT_STS      : 1;
		uint32_t OTG_INT_STS       : 1;
	}b;
