                                     ...
                                     uint8_t altSetting)
{
    if (phost->RequestState == CMD_SEND)
    {
        ...
        phost->Control.setup.b.wIndex.w = ep_idx;
        phost->Control.setup.b.wLength.w = 0U;
    }
                              ...
                              uint8_t *buf)
{
    ...
    printk("ep %x, max_size %d\n", ep_descriptor->bEndpointAddress, ep_descriptor->wMaxPacketSize);
}
...
static USBH_StatusTypeDef USBH_HandleControl(USBH_HandleTypeDef *phost)
{
    ...
    case CTRL_SETUP_WAIT:
        ...
        URB_Status = USBH_LL_GetURBState(phost, phost->Control.ep_idx);
    ...
    case CTRL_STATUS_IN:
        ...
        USBH_CtlReceiveData(phost, 0U, 0U, phost->Control.ep_idx);
    ...
    case CTRL_STATUS_OUT:
        USBH_CtlSendData(phost, 0U, 0U, phost->Control.ep_idx);
