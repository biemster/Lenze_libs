...
static USBH_StatusTypeDef DeInitStateMachine(USBH_HandleTypeDef *phost)
{
    ...
    phost->Control.max_pkt_sz = USBH_MPS_DEFAULT;
...
USBH_StatusTypeDef  USBH_Process(USBH_HandleTypeDef *phost)
{
    ...
    case HOST_DEV_ATTACHED :
        ...
        //TODO
        if (phost->device.speed == 3)
        {
            USBH_UsrLog("FULL Speed\n");
        }
        else
        {
            USBH_UsrLog("LOW Speed\n");
        }
        break;
...
static USBH_StatusTypeDef USBH_HandleEnum(USBH_HandleTypeDef *phost)
{
    ...
    case ENUM_IDLE:
        ...
        {
            phost->Control.max_pkt_sz = phost->device.DevDesc.bMaxPacketSize;
    ...
    case ENUM_SET_ADDR:
        ...
        if (ReqStatus == USBH_OK)
        {
            ...
            USBH_LL_Set_Device_Address(phost, phost->device.address);
...
USBH_StatusTypeDef  USBH_LL_Disconnect(USBH_HandleTypeDef *phost)
{
    ...
    USBH_LL_Set_Device_Address(phost, 0);
