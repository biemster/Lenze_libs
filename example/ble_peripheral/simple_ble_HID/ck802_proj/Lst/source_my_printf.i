# 1 "../../../../components/driver/source/my_printf.c"
...
# 3 "../../../../components/driver/source/my_printf.c" 2
...
# 4 "../../../../components/driver/source/my_printf.c" 2
...
# 7 "../../../../components/driver/source/my_printf.c" 2
# 1 "../../../../components/driver/include/uart.h" 1
# 8 "../../../../components/driver/source/my_printf.c" 2
# 1 "../../../../components/driver/include/log.h" 1
# 9 "../../../../components/driver/source/my_printf.c" 2


# 10 "../../../../components/driver/source/my_printf.c"
static void _uart_putc(char* data, uint16_t size)
{
    _symrom_hal_uart_send_buff(UART0, (uint8_t*)data, size);
}
...
# 18 "../../../../components/driver/source/my_printf.c" 3 4
   __builtin_va_start(
# 18 "../../../../components/driver/source/my_printf.c"
   args
# 18 "../../../../components/driver/source/my_printf.c" 3 4
   ,
# 18 "../../../../components/driver/source/my_printf.c"
...
# 18 "../../../../components/driver/source/my_printf.c"
                         ;
    _symrom_log_vsprintf(_uart_putc, format, args);
    
# 20 "../../../../components/driver/source/my_printf.c" 3 4
   __builtin_va_end(
# 20 "../../../../components/driver/source/my_printf.c"
   args
# 20 "../../../../components/driver/source/my_printf.c" 3 4
   )
# 20 "../../../../components/driver/source/my_printf.c"
...
void dbg_printf_init(void)
{
    uart_Cfg_t cfg =
    {
        ...
        .parity = 0,
        .evt_handler = 
# 41 "../../../../components/driver/source/my_printf.c" 3 4
                      ((void *)0)
# 41 "../../../../components/driver/source/my_printf.c"
                          ,
    };
    _symrom_JUMP_FUNCTION_SET(113,(uint32_t)&dbg_UART0_IRQHandler);
    _symrom_hal_uart_init(cfg, UART0);
}
