...
# 28 "../../../../components/arch/ck802/core_802.h" 2
...
void SystemInit(void)
{
    ...
    ((VIC_Type *) ((0xE000E000UL) + 0x0100UL) )->IABR[0] = 0x0;
    ((VIC_Type *) ((0xE000E000UL) + 0x0100UL) )->ICPR[0] = 0xFFFFFFFF;

    __enable_excp_irq();


    extern void trap_c(uint32_t *regs);
    _symrom_JUMP_FUNCTION_SET(99 , (uint32_t)&trap_c);
