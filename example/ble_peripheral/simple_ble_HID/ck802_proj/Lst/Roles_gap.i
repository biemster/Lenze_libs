# 1 "../../../../components/profiles/Roles/gap.c"
...
# 1 "../../../../components/profiles/Roles/gap.c"
# 44 "../../../../components/profiles/Roles/gap.c"
...
# 45 "../../../../components/profiles/Roles/gap.c" 2
...
# 54 "../../../../components/ble/include/gap.h" 2
...
# 46 "../../../../components/profiles/Roles/gap.c" 2
# 1 "../../../../components/ble/include/sm.h" 1
# 47 "../../../../components/profiles/Roles/gap.c" 2
# 86 "../../../../components/profiles/Roles/gap.c"
                           ...
                           uint32 *pSignCounter )
{
 ...
 bStatus_t stat = _symrom_GAP_ParamsInit( taskID, profileRole );
 if ( stat == 0x00 )
 {
...

  {
   ...
   _symrom_GAP_CentDevMgrInit( maxScanResponses );
  }
...

  {
   ...
   _symrom_GAP_PeriDevMgrInit();


   {

    _symrom_SM_ResponderInit();
   }
