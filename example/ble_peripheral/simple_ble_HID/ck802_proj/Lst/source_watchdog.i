# 1 "../../../../components/driver/source/watchdog.c"
...
# 1 "../../../../components/driver/source/watchdog.c"
# 32 "../../../../components/driver/source/watchdog.c"
...
# 33 "../../../../components/driver/source/watchdog.c" 2
...
# 40 "../../../../components/driver/include/watchdog.h" 2
...
# 41 "../../../../components/driver/include/watchdog.h" 2
...
# 34 "../../../../components/driver/source/watchdog.c" 2
...
# 35 "../../../../components/driver/source/watchdog.c" 2
...
void _symrom_clk_gate_enable(MODULE_e module);
void _symrom_clk_reset(MODULE_e module);
# 36 "../../../../components/driver/source/watchdog.c" 2
...
# 37 "../../../../components/driver/source/watchdog.c" 2

extern volatile uint8 g_clk32K_config;
extern uint32_t _symrom_s_config_swClk1;

WDG_CYCLE_Type_e g_wdt_cycle = 0xFF;
# 51 "../../../../components/driver/source/watchdog.c"
void hal_watchdog_init(void)
{



 extern uint32 _symrom_wdg_ms_cycle;
 extern uint8 _symrom_watchdog_TaskID;
 _symrom_wdg_ms_cycle = 0xFFF0;
 _symrom_watchdog_TaskID = 0xF0;
 _symrom_watchdog_init(g_wdt_cycle, 0);
 _symrom_s_config_swClk1|=((1ul << (5)));

 extern void _symrom_watchdog_sleep_handler(void);
 _symrom_watchdog_sleep_handler();
}
...
int hal_watchdog_config(WDG_CYCLE_Type_e cycle)
{
    ...
    hal_watchdog_init();
    _symrom_JUMP_FUNCTION_SET(127, (uint32_t)&hal_watchdog_init);
 return (0);
