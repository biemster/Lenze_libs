...
# 82 "../source/hidkbd.h"
                                               keyPressed);
# 58 "../source/hidkbd.c" 2
# 1 "../../../../components/ble/hci/hci_tl.h" 1
# 44 "../../../../components/ble/hci/hci_tl.h"
#define HCI_TL_H 
# 57 "../../../../components/ble/hci/hci_tl.h"
# 1 "../../../../components/driver/include/uart.h" 1
# 58 "../../../../components/ble/hci/hci_tl.h" 2
# 1 "../../../../components/ble/hci/hci_data.h" 1
# 44 "../../../../components/ble/hci/hci_data.h"
#define HCI_C_DATA_H 
# 101 "../../../../components/ble/hci/hci_data.h"
extern void HCI_ReverseBytes( uint8 *buf,
                              uint8 len );
# 59 "../../../../components/ble/hci/hci_tl.h" 2
# 1 "../../../../components/ble/hci/hci_event.h" 1
# 45 "../../../../components/ble/hci/hci_event.h"
#define HCI_C_EVENT_H 
# 55 "../../../../components/ble/hci/hci_event.h"
# 1 "../../../../components/ble/hci/hci_tl.h" 1
# 56 "../../../../components/ble/hci/hci_event.h" 2

extern uint32 bleEvtMask;
extern uint8 pHciEvtMask[];
# 69 "../../../../components/ble/hci/hci_event.h"
...
# 406 "../../../../components/ble/hci/hci_tl.h"
extern void _symrom_HCI_Init( uint8 taskID );
# 425 "../../../../components/ble/hci/hci_tl.h"
extern uint16 _symrom_HCI_ProcessEvent( uint8 task_id,
                                uint16 events );
# 59 "../source/hidkbd.c" 2
...
# 61 "../source/hidkbd.c" 2
# 1 "../../../../components/ble/controller/ll_def.h" 1
# 62 "../source/hidkbd.c" 2
# 1 "../../../../components/osal/include/OSAL_Memory.h" 1
# 63 "../source/hidkbd.c" 2
# 1 "../../../../components/driver/include/log.h" 1
# 64 "../source/hidkbd.c" 2
...
# 153 "../source/hidkbd.c"
    static void hidCCSendReport( uint8 cmd, 
# 153 "../source/hidkbd.c" 3 4
                                           _Bool 
# 153 "../source/hidkbd.c"
                                                keyPressed, uint8 keyRepeated );
    void hidCCSendReportKey( uint8 cmd, 
# 154 "../source/hidkbd.c" 3 4
                                       _Bool 
# 154 "../source/hidkbd.c"
                                            keyPressed);
# 179 "../source/hidkbd.c"
void HidKbd_Init( uint8 task_id )
{
    ...
    HidKbd_AddService();
    _symrom_osal_set_event( application_TaskID, 0x0001 );
...
uint16 HidKbd_ProcessEvent( uint8 task_id, uint16 events )
{
    ...
    if ( events & 0x8000 )
    {
        ...
        if ( (pMsg = _symrom_osal_msg_receive( application_TaskID )) != 0 )
        {
