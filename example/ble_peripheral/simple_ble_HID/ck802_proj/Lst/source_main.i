...
uint8 g_pConnectionBuffer[(1 * ( (4 * (((0 == 1) ? 1 : 0) * 262 + ((0 == 0) ? 1 : 0) * 42 + (sizeof(struct ll_pkt_desc) - 2))*2) +(4 * (((0 == 1) ? 1 : 0) * 262 + ((0 == 0) ? 1 : 0) * 42 + (sizeof(struct ll_pkt_desc) - 2))) + (((0 == 1) ? 1 : 0) * 262 + ((0 == 0) ? 1 : 0) * 42 + (sizeof(struct ll_pkt_desc) - 2)) ))] __attribute__ ((aligned(4)));
...
uint8 g_largeHeap[(3*1024)] __attribute__ ((aligned(4)));
...
{
    _symrom_osal_mem_set_heap((osalMemHdr_t*)g_largeHeap, (3*1024));
...
int main(void)
{
    ...
    if(_symrom_gpio_read(P20)==1)
 {
    ...
    dbg_printf("sizeof(struct ll_pkt_desc) = %d, buf size = %d\n", sizeof(struct ll_pkt_desc), (1 * ( (4 * (((0 == 1) ? 1 : 0) * 262 + ((0 == 0) ? 1 : 0) * 42 + (sizeof(struct ll_pkt_desc) - 2))*2) +(4 * (((0 == 1) ? 1 : 0) * 262 + ((0 == 0) ? 1 : 0) * 42 + (sizeof(struct ll_pkt_desc) - 2))) + (((0 == 1) ? 1 : 0) * 262 + ((0 == 0) ? 1 : 0) * 42 + (sizeof(struct ll_pkt_desc) - 2)) )));
