...
# 46 "../source/HIDkbd_Main.c" 2
# 1 "../../../../components/osal/include/osal_snv.h" 1
# 41 "../../../../components/osal/include/osal_snv.h"
#define OSAL_SNV_H 
# 71 "../../../../components/osal/include/osal_snv.h"
  typedef uint8 osalSnvId_t;
  typedef uint8 osalSnvLen_t;
# 90 "../../../../components/osal/include/osal_snv.h"
extern uint8 osal_snv_init( void );
# 104 "../../../../components/osal/include/osal_snv.h"
extern uint8 osal_snv_read( osalSnvId_t id, osalSnvLen_t len, void *pBuf);
# 117 "../../../../components/osal/include/osal_snv.h"
extern uint8 osal_snv_write( osalSnvId_t id, osalSnvLen_t len, void *pBuf);
# 130 "../../../../components/osal/include/osal_snv.h"
extern uint8 osal_snv_compact( uint8 threshold );
# 47 "../source/HIDkbd_Main.c" 2
# 59 "../source/HIDkbd_Main.c"
int app_main(void)
{

    _symrom_osal_init_system();
    _symrom_osal_pwrmgr_device( 1 );

    _symrom_osal_start_system();
    return 0;
}
