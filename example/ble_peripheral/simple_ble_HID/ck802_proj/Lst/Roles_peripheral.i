# 1 "../../../../components/profiles/Roles/peripheral.c"
...
# 1 "../../../../components/profiles/Roles/peripheral.c"
# 46 "../../../../components/profiles/Roles/peripheral.c"
...
# 47 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 37 "../../../../components/ble/controller/ll_common.h" 2
...
# 48 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 50 "../../../../components/profiles/Roles/peripheral.c" 2
# 1 "../../../../components/ble/hci/hci_tl.h" 1
# 44 "../../../../components/ble/hci/hci_tl.h"
#define HCI_TL_H 
# 55 "../../../../components/ble/hci/hci_tl.h"
...
# 56 "../../../../components/ble/hci/hci_tl.h" 2
...
extern uint16 _symrom_HCI_ProcessEvent( uint8 task_id,
                                uint16 events );
# 51 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 52 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 53 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 54 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 55 "../../../../components/profiles/Roles/peripheral.c" 2
# 1 "../../../../components/ble/include/gatt.h" 1
# 47 "../../../../components/ble/include/gatt.h"
#define GATT_H 
# 60 "../../../../components/ble/include/gatt.h"
# 1 "../../../../components/ble/include/att.h" 1
...
# 56 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 57 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 58 "../../../../components/profiles/Roles/peripheral.c" 2
...
# 59 "../../../../components/profiles/Roles/peripheral.c" 2
...
#define GAP_DEFAULT_PARAM_UPDATE_PAUSE 6
#define PARAM_UPDATE_EVT 0x0008
#define GAP_DEFAULT_DESIRED_MIN_CONN_INTERVAL 80
#define GAP_DEFAULT_DESIRED_MAX_CONN_INTERVAL 80
#define GAP_DEFAULT_DESIRED_SLAVE_LATENCY 0
#define GAP_DEFAULT_DESIRED_CONN_TIMEOUT 500
...
# 150 "../../../../components/profiles/Roles/peripheral.c"
...
uint16 gapRole_ConnectionHandle = 0xFFFF;
...
void GAPRole_Init( uint8 task_id )
{
 ...
 _symrom_GAP_RegisterForHCIMsgs(gapRole_TaskID);
}
...
uint16 GAPRole_ProcessEvent( uint8 task_id, uint16 events )
{
 ...
 if ( events & 0x8000 )
 {
  ...
  if ( (pMsg = _symrom_osal_msg_receive( gapRole_TaskID )) != 0 )
  {
...
# 271 "../../../../components/profiles/Roles/peripheral.c"
 return 0;
}
# 283 "../../../../components/profiles/Roles/peripheral.c"
static void gapRole_ProcessOSALMsg( osal_event_hdr_t *pMsg )
{
 ...
 switch ( pMsg->event )
 {
  ...
  case 0x91:
  {
   switch( pMsg->status )
   {
    case 0x0E :
    {
# 316 "../../../../components/profiles/Roles/peripheral.c"
    }
    break;
    case 0x0F:
    {
# 330 "../../../../components/profiles/Roles/peripheral.c"
    }
    break;
    case 0x3E:
    {
     hciEvt_BLEEvent_Hdr_t *pPkt = (hciEvt_BLEEvent_Hdr_t *)pMsg;
              if ( pPkt->BLEEventCode == 0x07 )
              {
# 345 "../../../../components/profiles/Roles/peripheral.c"
              }
              else if(pPkt->BLEEventCode == 0x0C )
              {
  ...
  case 0xA2:
       {
         ...
         if ( pPkt->opcode == 0x13 )
         {
# 384 "../../../../components/profiles/Roles/peripheral.c"
         }
  }
  break;
  default:
...
# 405 "../../../../components/profiles/Roles/peripheral.c"
static void gapRole_ProcessGAPMsg( gapEventHdr_t *pMsg )
{
 ...
 switch ( pMsg->opcode )
 {
  case 0x00:
  {
   gapDeviceInitDoneEvent_t *pPkt = (gapDeviceInitDoneEvent_t *)pMsg;
    ...
    dbg_printf("Device Address(LSB to MSB): ");
    my_dump_byte(pPkt->devAddr,6);
   ...
   if ( pPkt->hdr.status == 0x00 )
   {
...

     {
       ...
       uint8 advertData[] ={0x02,0x01,( 0x02 | 0x04 ),
      ...
      _symrom_GAP_UpdateAdvertisingData( (gapRole_TaskID),1, sizeof(advertData), advertData );
     }
    ...
    if ( pPkt->hdr.status == 0x00 )
    {
     if ( pPkt->adType )
     {
      ...
      uint8 scanRspData[] ={ 0x03,
            ...
            0x09,
            'J','A','C','K','-','H','I','D' };
# 502 "../../../../components/profiles/Roles/peripheral.c"
      status = _symrom_GAP_UpdateAdvertisingData( (gapRole_TaskID),0, sizeof(scanRspData), scanRspData);
      if( 0x00 != status )
      {
      ...
      else
      {
       ...
       gapAdvertisingParams_t advParams={
            .eventType = 0x00,
            .initiatorAddrType = 0x01 ,
            .initiatorAddr = {0xCC,0x01,0x02,0x03,0x04,0x05},
            .channelMap = ( 0x01 | 0x02 | 0x04 ),
            .filterPolicy = 0x00,
            };
       status = _symrom_GAP_MakeDiscoverable( (gapRole_TaskID), &advParams );
   ...
   case 0x03:
   {
     ...
     dbg_printf("%s,pMsg->opcode:0x%04X GAP Make advertising discoverable done,status 0x%X\n",__func__,pMsg->opcode,pPkt->hdr.status);
     if( pPkt->hdr.status == 0x00 )
     {
      dbg_printf("GAP Advertising started...\n");
     }
     else
      dbg_printf("GAP Advertising start failure\n");
   ...
   case 0x04:
   {
     ...
     gapMakeDiscoverableRspEvent_t *pPkt = (gapMakeDiscoverableRspEvent_t *)pMsg;
     dbg_printf("%s,pMsg->opcode:0x%04X GAP End advertising discoverable done,status 0x%X\n",__func__,pMsg->opcode,pPkt->hdr.status);
    if( pPkt->hdr.status == 0x00 )
     dbg_printf("GAP Advertising stoped...\n");
    else
     dbg_printf("GAP Advertising stop failure\n");
   ...
   case 0x05:
   {
    ...
    gapRole_ConnectionHandle = pPkt->connectionHandle;
     ...
     dbg_printf("%s,pMsg->opcode:0x%04X GAP Link Established,status 0x%X\n",__func__,pMsg->opcode,pPkt->hdr.status);
     dbg_printf("	connection handle 		%d\n",pPkt->connectionHandle);
     dbg_printf("	connection interval 	%d\n",pPkt->connInterval);
     dbg_printf("	connection latency 	%d\n",pPkt->connLatency);
     dbg_printf("	connection timeout 	%d\n",pPkt->connTimeout);
     dbg_printf("	connection devAddrType	%d,device Address:0x",pPkt->devAddrType);
     for(uint8 i=0;i<6;i++)
      dbg_printf("%02X",pPkt->devAddr[i]);
     dbg_printf("\n");
# 617 "../../../../components/profiles/Roles/peripheral.c"
   }
   break;
   case 0x06:
   {
    gapRole_ConnectionHandle = 0xFFFF;
# 635 "../../../../components/profiles/Roles/peripheral.c"
     gapTerminateLinkEvent_t *pPkt = (gapTerminateLinkEvent_t *)pMsg;
     dbg_printf("%s,pMsg->opcode:0x%04X GAP Link Terminated,status 0x%X\n",__func__,pMsg->opcode,pPkt->hdr.status);
     if( pPkt->hdr.status == 0x00 )
     {
      dbg_printf("	connection handle	%d\n",pPkt->connectionHandle);
      dbg_printf("	reason				%d\n",pPkt->reason);
    ...
    _symrom_GAP_MakeDiscoverable( (gapRole_TaskID), &advParams );
   }
   break;
   case 0x07:
   {
# 666 "../../../../components/profiles/Roles/peripheral.c"
   }
   break;
  ...
  case 0x0D:
  {
# 685 "../../../../components/profiles/Roles/peripheral.c"
  }
  break;
  case 0x01:
  {
...
# 714 "../../../../components/profiles/Roles/peripheral.c"
static void gapRole_SetupGAP( void )
{
