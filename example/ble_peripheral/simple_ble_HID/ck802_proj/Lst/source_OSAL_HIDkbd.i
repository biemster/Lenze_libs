...
# 42 "../source/OSAL_HIDkbd.c" 2
# 1 "../../../../components/osal/include/OSAL_Tasks.h" 1
# 12 "../../../../components/osal/include/OSAL_Tasks.h"
#define OSAL_TASKS_H 
# 30 "../../../../components/osal/include/OSAL_Tasks.h"
#define TASK_NO_TASK 0xFF
# 39 "../../../../components/osal/include/OSAL_Tasks.h"
...
# 56 "../../../../components/osal/include/OSAL_Tasks.h"
extern void osalInitTasks( void );
# 43 "../source/OSAL_HIDkbd.c" 2
...
extern uint16 _symrom_HCI_ProcessEvent( uint8 task_id,
                                uint16 events );
# 48 "../source/OSAL_HIDkbd.c" 2


# 1 "../../../../components/osal/include/osal_cbTimer.h" 1
# 12 "../../../../components/osal/include/osal_cbTimer.h"
#define OSAL_CBTIMER_H 
# 27 "../../../../components/osal/include/osal_cbTimer.h"
#define INVALID_TIMER_ID 0xFF


#define TIMEOUT_TIMER_ID 0xFE
# 39 "../../../../components/osal/include/osal_cbTimer.h"
#define OSAL_CBTIMER_NUM_TASKS 1



#define OSAL_CBTIMER_PROCESS_EVENT(a) ( a )
# 59 "../../../../components/osal/include/osal_cbTimer.h"
typedef void (*pfnCbTimer_t)( uint8 *pData );
# 72 "../../../../components/osal/include/osal_cbTimer.h"
extern void _symrom_osal_CbTimerInit( uint8 taskId );




extern uint16 _symrom_osal_CbTimerProcessEvent( uint8 taskId, uint16 events );




extern Status_t _symrom_osal_CbTimerStart( pfnCbTimer_t pfnCbTimer, uint8 *pData,
...
extern Status_t _symrom_osal_CbTimerStop( uint8 timerId );
# 51 "../source/OSAL_HIDkbd.c" 2
...
{
 _symrom_LL_ProcessEvent,
 _symrom_HCI_ProcessEvent,

 ( _symrom_osal_CbTimerProcessEvent ),

 _symrom_L2CAP_ProcessEvent,
 _symrom_GAP_ProcessEvent,
 _symrom_GATT_ProcessEvent,
 _symrom_SM_ProcessEvent,
...
uint16* tasksEvents;
# 112 "../source/OSAL_HIDkbd.c"
void osalInitTasks( void )
{
    uint8 taskID = 0;
    tasksEvents = (uint16*)_symrom_osal_mem_alloc( sizeof( uint16 ) * tasksCnt);
    _symrom_osal_memset( tasksEvents, 0, (sizeof( uint16 ) * tasksCnt));

 _symrom_LL_Init( taskID++ );


 _symrom_HCI_Init( taskID++ );



 _symrom_osal_CbTimerInit( taskID );
 taskID += 1;



 _symrom_L2CAP_Init( taskID++ );


 _symrom_GAP_Init( taskID++ );


 _symrom_GATT_Init( taskID++ );


 _symrom_SM_Init( taskID++ );
