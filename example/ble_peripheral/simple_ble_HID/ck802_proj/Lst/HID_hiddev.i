# 1 "../../../../components/profiles/HID/hiddev.c"
...
# 1 "../../../../components/profiles/HID/hiddev.c"
# 38 "../../../../components/profiles/HID/hiddev.c"
...
# 29 "../../../../components/osal/include/comdef.h" 2
...
# 30 "../../../../components/osal/include/OSAL.h" 2
...
# 40 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/include/gatt.h" 1
# 47 "../../../../components/ble/include/gatt.h"
#define GATT_H 
# 57 "../../../../components/ble/include/gatt.h"
# 1 "../../../../components/ble/include/bcomdef.h" 1
# 47 "../../../../components/ble/include/bcomdef.h"
#define BCOMDEF_H 
# 60 "../../../../components/ble/include/bcomdef.h"
# 1 "../../../../components/osal/include/comdef.h" 1
# 61 "../../../../components/ble/include/bcomdef.h" 2
...
# 10 "../../../../components/driver/include/uart.h" 2
...
# 11 "../../../../components/driver/include/uart.h" 2
...
# 58 "../../../../components/ble/include/gatt.h" 2


# 1 "../../../../components/ble/include/att.h" 1
# 49 "../../../../components/ble/include/att.h"
#define ATT_H 
# 62 "../../../../components/ble/include/att.h"
...
# 63 "../../../../components/ble/include/att.h" 2
# 72 "../../../../components/ble/include/att.h"
...
# 143 "../../../../components/ble/include/att.h"
...
# 218 "../../../../components/ble/include/att.h"
...
# 239 "../../../../components/ble/include/att.h"
typedef struct
{
  uint8 sig;
  uint8 cmd;
...
typedef union
{
  attHandleBtUUID_t btPair[( ( 23 - 2 ) / ( 2 + 2 ) )];
  attHandleUUID_t pair[( ( 23 - 2 ) / ( 2 + 16 ) )];
} attFindInfo_t;
...
{
  uint8 numInfo;
  attHandlesInfo_t handlesInfo[( ( 247 - 1 ) / 4 )];
...
# 581 "../../../../components/ble/include/att.h"
extern uint8 ATT_ParsePacket( l2capDataEvent_t *pL2capMsg, attPacket_t *pPkt );




extern uint8 _symrom_ATT_CompareUUID( const uint8 *pUUID1, uint16 len1,
...
# 606 "../../../../components/ble/include/att.h"
...
# 781 "../../../../components/ble/include/att.h"
...
# 856 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ExchangeMTUReq( uint16 connHandle, attExchangeMTUReq_t *pReq );
# 870 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_FindInfoReq( uint16 connHandle, attFindInfoReq_t *pReq );
# 884 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_FindByTypeValueReq( uint16 connHandle, attFindByTypeValueReq_t *pReq );
# 898 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ReadByTypeReq( uint16 connHandle, attReadByTypeReq_t *pReq );
# 912 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ReadReq( uint16 connHandle, attReadReq_t *pReq );
# 926 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ReadBlobReq( uint16 connHandle, attReadBlobReq_t *pReq );
# 940 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ReadMultiReq( uint16 connHandle, attReadMultiReq_t *pReq );
# 954 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ReadByGrpTypeReq( uint16 connHandle, attReadByGrpTypeReq_t *pReq );
# 969 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_WriteReq( uint16 connHandle, attWriteReq_t *pReq );
# 983 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_PrepareWriteReq( uint16 connHandle, attPrepareWriteReq_t *pReq );
# 997 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_ExecuteWriteReq( uint16 connHandle, attExecuteWriteReq_t *pReq );
# 1010 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_HandleValueCfm( uint16 connHandle );
# 1038 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ErrorRsp( uint16 connHandle, attErrorRsp_t *pRsp );
# 1052 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ExchangeMTURsp( uint16 connHandle, attExchangeMTURsp_t *pRsp );
# 1066 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_FindInfoRsp( uint16 connHandle, attFindInfoRsp_t *pRsp );
# 1080 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_FindByTypeValueRsp( uint16 connHandle, attFindByTypeValueRsp_t *pRsp );
# 1094 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ReadByTypeRsp( uint16 connHandle, attReadByTypeRsp_t *pRsp );
# 1108 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ReadRsp( uint16 connHandle, attReadRsp_t *pRsp );
# 1122 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ReadBlobRsp( uint16 connHandle, attReadBlobRsp_t *pRsp );
# 1136 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ReadMultiRsp( uint16 connHandle, attReadMultiRsp_t *pRsp ) ;
# 1150 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ReadByGrpTypeRsp( uint16 connHandle, attReadByGrpTypeRsp_t *pRsp );
# 1163 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_WriteRsp( uint16 connHandle );
# 1177 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_PrepareWriteRsp( uint16 connHandle, attPrepareWriteRsp_t *pRsp );
# 1190 "../../../../components/ble/include/att.h"
extern bStatus_t _symrom_ATT_ExecuteWriteRsp( uint16 connHandle );
# 1204 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_HandleValueNoti( uint16 connHandle, attHandleValueNoti_t *pNoti );
# 1218 "../../../../components/ble/include/att.h"
extern bStatus_t ATT_HandleValueInd( uint16 connHandle, attHandleValueInd_t *pInd );
# 1232 "../../../../components/ble/include/att.h"
extern void ATT_SetParamValue( uint16 value );
# 1241 "../../../../components/ble/include/att.h"
extern uint16 ATT_GetParamValue( void );

extern uint16 _symrom_ATT_GetCurrentMTUSize( uint16 connHandle );
...
extern uint16 _symrom_g_ATT_MTU_SIZE_MAX;
extern uint16 g_ATT_MAX_NUM_HANDLES;
extern uint16 _symrom_g_ATT_MAX_NUM_HANDLES_INFO;
...
# 61 "../../../../components/ble/include/gatt.h" 2
# 70 "../../../../components/ble/include/gatt.h"
...
#define GATT_MAX_NUM_PREPARE_WRITES 1
# 97 "../../../../components/ble/include/gatt.h"
#define GATT_ENCRYPT_KEY_SIZE 16
# 106 "../../../../components/ble/include/gatt.h"
...
# 130 "../../../../components/ble/include/gatt.h"
...
# 158 "../../../../components/ble/include/gatt.h"
typedef struct
{
...
# 308 "../../../../components/ble/include/gatt.h"
extern bStatus_t GATT_InitClient( void );
# 318 "../../../../components/ble/include/gatt.h"
extern void GATT_RegisterForInd( uint8 taskId );
# 338 "../../../../components/ble/include/gatt.h"
extern bStatus_t GATT_PrepareWriteReq( uint16 connHandle, attPrepareWriteReq_t *pReq, uint8 taskId );
# 359 "../../../../components/ble/include/gatt.h"
extern bStatus_t GATT_ExecuteWriteReq( uint16 connHandle, attExecuteWriteReq_t *pReq, uint8 taskId );
# 380 "../../../../components/ble/include/gatt.h"
extern bStatus_t GATT_InitServer( void );
# 407 "../../../../components/ble/include/gatt.h"
extern bStatus_t _symrom_GATT_RegisterService( gattService_t *pService );
# 421 "../../../../components/ble/include/gatt.h"
extern bStatus_t GATT_DeregisterService( uint16 handle, gattService_t *pService );
# 430 "../../../../components/ble/include/gatt.h"
extern void _symrom_GATT_RegisterForReq( uint8 taskId );
# 444 "../../../../components/ble/include/gatt.h"
extern bStatus_t _symrom_GATT_VerifyReadPermissions( uint16 connHandle, uint8 permissions );
# 459 "../../../../components/ble/include/gatt.h"
extern bStatus_t GATT_VerifyWritePermissions( uint16 connHandle, uint8 permissions, attWriteReq_t *pReq );
# 474 "../../../../components/ble/include/gatt.h"
extern uint8 GATT_ServiceChangedInd( uint16 connHandle, uint8 taskId );
# 487 "../../../../components/ble/include/gatt.h"
extern gattAttribute_t *_symrom_GATT_FindHandleUUID( uint16 startHandle, uint16 endHandle, const uint8 *pUUID,
                                             uint16 len, uint16 *pHandle );
# 497 "../../../../components/ble/include/gatt.h"
extern gattAttribute_t *_symrom_GATT_FindHandle( uint16 handle, uint16 *pHandle );
# 509 "../../../../components/ble/include/gatt.h"
extern gattAttribute_t *_symrom_GATT_FindNextAttr( gattAttribute_t *pAttr, uint16 endHandle,
...
# 63 "../../../../components/ble/controller/ll.h" 2
...
# 42 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/host/gapgattserver.h" 1
# 46 "../../../../components/ble/host/gapgattserver.h"
#define GAPGATTSERVER_H 
# 61 "../../../../components/ble/host/gapgattserver.h"
...
#define GGS_PERI_PRIVACY_FLAG_ATT 2
#define GGS_RECONNCT_ADDR_ATT 3
#define GGS_PERI_CONN_PARAM_ATT 4
#define GGS_PERI_PRIVACY_FLAG_PROPS 5
#define GGS_W_PERMIT_DEVICE_NAME_ATT 6
#define GGS_W_PERMIT_APPEARANCE_ATT 7
#define GGS_W_PERMIT_PRIVACY_FLAG_ATT 8
...
# 97 "../../../../components/ble/host/gapgattserver.h"
typedef void (*ggsAttrValueChange_t)( uint8 attrId );


typedef struct
{
  ggsAttrValueChange_t pfnAttrValueChange;
} ggsAppCBs_t;
# 129 "../../../../components/ble/host/gapgattserver.h"
extern bStatus_t GGS_SetParameter( uint8 param, uint8 len, void *value );
# 142 "../../../../components/ble/host/gapgattserver.h"
extern bStatus_t GGS_GetParameter( uint8 param, void *value );
# 155 "../../../../components/ble/host/gapgattserver.h"
extern bStatus_t GGS_AddService( );
# 169 "../../../../components/ble/host/gapgattserver.h"
extern void GGS_RegisterAppCBs( ggsAppCBs_t *appCallbacks );
# 179 "../../../../components/ble/host/gapgattserver.h"
extern void GGS_SetParamValue( uint16 value );
# 188 "../../../../components/ble/host/gapgattserver.h"
extern uint16 GGS_GetParamValue( void );
# 43 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/host/gattservapp.h" 1
# 47 "../../../../components/ble/host/gattservapp.h"
#define GATTSERVAPP_H 
# 68 "../../../../components/ble/host/gattservapp.h"
#define GATT_CLIENT_CHAR_CFG_UPDATED_EVENT 0x00
# 77 "../../../../components/ble/host/gattservapp.h"
...
# 183 "../../../../components/ble/host/gattservapp.h"
#define GATT_PARAM_NUM_PREPARE_WRITES 0
# 194 "../../../../components/ble/host/gattservapp.h"
...
# 579 "../../../../components/ble/host/gattservapp.h"
extern uint8 GATTServApp_WriteAttr( uint16 connHandle, uint16 handle,
                                    uint8 *pValue, uint16 len, uint16 offset );
# 594 "../../../../components/ble/host/gattservapp.h"
extern void GATTServApp_SetParamValue( uint16 value );
# 603 "../../../../components/ble/host/gattservapp.h"
extern uint16 GATTServApp_GetParamValue( void );
# 619 "../../../../components/ble/host/gattservapp.h"
extern void GATTServApp_Init( uint8 taskId );
# 634 "../../../../components/ble/host/gattservapp.h"
extern uint16 GATTServApp_ProcessEvent( uint8 taskId, uint16 events );
# 44 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/include/gatt_uuid.h" 1
# 45 "../../../../components/ble/include/gatt_uuid.h"
#define GATT_UUID_H 
# 69 "../../../../components/ble/include/gatt_uuid.h"
...
# 118 "../../../../components/ble/include/gatt_uuid.h"
extern const uint8 _symrom_gapServiceUUID[];
extern const uint8 _symrom_gattServiceUUID[];




extern const uint8 _symrom_primaryServiceUUID[];
extern const uint8 _symrom_secondaryServiceUUID[];
extern const uint8 _symrom_includeUUID[];
extern const uint8 _symrom_characterUUID[];




extern const uint8 charExtPropsUUID[];
extern const uint8 _symrom_charUserDescUUID[];
extern const uint8 _symrom_clientCharCfgUUID[];
...
extern const uint8 _symrom_extReportRefUUID[];
extern const uint8 _symrom_reportRefUUID[];




extern const uint8 _symrom_deviceNameUUID[];
extern const uint8 _symrom_appearanceUUID[];
extern const uint8 periPrivacyFlagUUID[];
extern const uint8 reconnectAddrUUID[];
extern const uint8 _symrom_periConnParamUUID[];
extern const uint8 _symrom_serviceChangedUUID[];
...
# 45 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/host/gatt_profile_uuid.h" 1
# 45 "../../../../components/ble/host/gatt_profile_uuid.h"
#define GATT_PROFILE_UUID_H 
# 69 "../../../../components/ble/host/gatt_profile_uuid.h"
#define IMMEDIATE_ALERT_SERV_UUID 0x1802
#define LINK_LOSS_SERV_UUID 0x1803
#define TX_PWR_LEVEL_SERV_UUID 0x1804
#define CURRENT_TIME_SERV_UUID 0x1805
#define REF_TIME_UPDATE_SERV_UUID 0x1806
#define NEXT_DST_CHANGE_SERV_UUID 0x1807
#define GLUCOSE_SERV_UUID 0x1808
#define THERMOMETER_SERV_UUID 0x1809
#define DEVINFO_SERV_UUID 0x180A
#define NWA_SERV_UUID 0x180B
#define HEARTRATE_SERV_UUID 0x180D
#define PHONE_ALERT_STS_SERV_UUID 0x180E
#define BATT_SERV_UUID 0x180F
#define BLOODPRESSURE_SERV_UUID 0x1810
#define ALERT_NOTIF_SERV_UUID 0x1811
#define HID_SERV_UUID 0x1812
#define SCAN_PARAM_SERV_UUID 0x1813
#define RSC_SERV_UUID 0x1814
#define CSC_SERV_UUID 0x1816
#define CYCPWR_SERV_UUID 0x1818
#define LOC_NAV_SERV_UUID 0x1819




#define ALERT_LEVEL_UUID 0x2A06
#define TX_PWR_LEVEL_UUID 0x2A07
#define DATE_TIME_UUID 0x2A08
#define DAY_OF_WEEK_UUID 0x2A09
#define DAY_DATE_TIME_UUID 0x2A0A
#define EXACT_TIME_256_UUID 0x2A0C
#define DST_OFFSET_UUID 0x2A0D
#define TIME_ZONE_UUID 0x2A0E
#define LOCAL_TIME_INFO_UUID 0x2A0F
#define TIME_WITH_DST_UUID 0x2A11
#define TIME_ACCURACY_UUID 0x2A12
#define TIME_SOURCE_UUID 0x2A13
#define REF_TIME_INFO_UUID 0x2A14
#define TIME_UPDATE_CTRL_PT_UUID 0x2A16
#define TIME_UPDATE_STATE_UUID 0x2A17
...
#define BLOODPRESSURE_MEAS_UUID 0x2A35
#define IMEDIATE_CUFF_PRESSURE_UUID 0x2A36
#define HEARTRATE_MEAS_UUID 0x2A37
#define BODY_SENSOR_LOC_UUID 0x2A38
#define HEARTRATE_CTRL_PT_UUID 0x2A39
#define NETWORK_AVAIL_UUID 0x2A3E
#define ALERT_STATUS_UUID 0x2A3F
#define RINGER_CTRL_PT_UUID 0x2A40
#define RINGER_SETTING_UUID 0x2A41
#define ALERT_CAT_ID_BMASK_UUID 0x2A42
#define ALERT_CAT_ID_UUID 0x2A43
#define ALERT_NOTIF_CTRL_PT_UUID 0x2A44
#define UNREAD_ALERT_STATUS_UUID 0x2A45
#define NEW_ALERT_UUID 0x2A46
#define SUP_NEW_ALERT_CAT_UUID 0x2A47
#define SUP_UNREAD_ALERT_CAT_UUID 0x2A48
#define BLOODPRESSURE_FEATURE_UUID 0x2A49
...
#define RECORD_CTRL_PT_UUID 0x2A52
#define RSC_MEAS_UUID 0x2A53
#define RSC_FEATURE_UUID 0x2A54
#define SC_CTRL_PT_UUID 0x2A55
#define CSC_MEAS_UUID 0x2A5B
#define CSC_FEATURE_UUID 0x2A5C
#define SENSOR_LOC_UUID 0x2A5D
#define CYCPWR_MEAS_UUID 0x2A63
#define CYCPWR_VECTOR_UUID 0x2A64
#define CYCPWR_FEATURE_UUID 0x2A65
#define CYCPWR_CTRL_PT_UUID 0x2A66
#define LOC_SPEED_UUID 0x2A67
#define NAV_UUID 0x2A68
#define POS_QUALITY_UUID 0x2A69
#define LN_FEATURE_UUID 0x2A6A
#define LN_CTRL_PT_UUID 0x2A6B




#define GATT_UNITLESS_UUID 0x2700
#define GATT_UNIT_LENGTH_METER_UUID 0x2701
#define GATT_UNIT_MASS_KGRAM_UUID 0x2702
#define GATT_UNIT_TIME_SECOND_UUID 0x2703
#define GATT_UNIT_ELECTRIC_CURRENT_A_UUID 0x2704
#define GATT_UNIT_THERMODYN_TEMP_K_UUID 0x2705
#define GATT_UNIT_AMOUNT_SUBSTANCE_M_UUID 0x2706
#define GATT_UNIT_LUMINOUS_INTENSITY_C_UUID 0x2707

#define GATT_UNIT_AREA_SQ_MTR_UUID 0x2710
#define GATT_UNIT_VOLUME_CUBIC_MTR_UUID 0x2711
#define GATT_UNIT_VELOCITY_MPS_UUID 0x2712
#define GATT_UNIT_ACCELERATION_MPS_SQ_UUID 0x2713
#define GATT_UNIT_WAVENUMBER_RM_UUID 0x2714
#define GATT_UNIT_DENSITY_KGPCM_UUID 0x2715
#define GATT_UNIT_SURFACE_DENSITY_KGPSM_UUID 0x2716
#define GATT_UNIT_SPECIFIC_VOLUME_CMPKG_UUID 0x2717
#define GATT_UNIT_CURRENT_DENSITY_APSM_UUID 0x2718
#define GATT_UNIT_MAG_FIELD_STRENGTH_UUID 0x2719
#define GATT_UNIT_AMOUNT_CONC_MPCM_UUID 0x271A
#define GATT_UNIT_MASS_CONC_KGPCM_UUID 0x271B
#define GATT_UNIT_LUMINANCE_CPSM_UUID 0x271C
#define GATT_UNIT_REFRACTIVE_INDEX_UUID 0x271D
#define GATT_UNIT_RELATIVE_PERMEABLILTY_UUID 0x271E
#define GATT_UNIT_PLANE_ANGLE_RAD_UUID 0x2720
#define GATT_UNIT_SOLID_ANGLE_STERAD_UUID 0x2721
#define GATT_UNIT_FREQUENCY_HTZ_UUID 0x2722
#define GATT_UNIT_FORCE_NEWTON_UUID 0x2723
#define GATT_UNIT_PRESSURE_PASCAL_UUID 0x2724
#define GATT_UNIT_ENERGY_JOULE_UUID 0x2725
#define GATT_UNIT_POWER_WATT_UUID 0x2726
#define GATT_UNIT_E_CHARGE_C_UUID 0x2727
#define GATT_UNIT_E_POTENTIAL_DIF_V_UUID 0x2728

#define GATT_UNIT_CELSIUS_TEMP_DC_UUID 0x272F

#define GATT_UNIT_TIME_MINUTE_UUID 0x2760
#define GATT_UNIT_TIME_HOUR_UUID 0x2761
#define GATT_UNIT_TIME_DAY_UUID 0x2762
#define GATT_UNIT_PLANE_ANGLE_DEGREE_UUID 0x2763
#define GATT_UNIT_PLANE_ANGLE_MINUTE_UUID 0x2764
#define GATT_UNIT_PLANE_ANGLE_SECOND_UUID 0x2765
#define GATT_UNIT_AREA_HECTARE_UUID 0x2766
#define GATT_UNIT_VOLUME_LITRE_UUID 0x2767
#define GATT_UNIT_MASS_TONNE_UUID 0x2768

#define GATT_UINT_LENGTH_YARD_UUID 0x27A0
#define GATT_UNIT_LENGTH_PARSEC_UUID 0x27A1
#define GATT_UNIT_LENGTH_INCH_UUID 0x27A2
#define GATT_UNIT_LENGTH_FOOT_UUID 0x27A3
#define GATT_UNIT_LENGTH_MILE_UUID 0x27A4
#define GATT_UNIT_PRESSURE_PFPSI_UUID 0x27A5
#define GATT_UNIT_VELOCITY_KMPH_UUID 0x27A6
#define GATT_UNIT_VELOCITY_MPH_UUID 0x27A7
#define GATT_UNIT_ANGULAR_VELOCITY_RPM_UUID 0x27A8
#define GATT_UNIT_ENERGY_GCAL_UUID 0x27A9
#define GATT_UNIT_ENERGY_KCAL_UUID 0x27AA
#define GATT_UNIT_ENERGY_KWH_UUID 0x27AB
#define GATT_UNIT_THERMODYN_TEMP_DF_UUID 0x27AC
...
# 46 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/host/linkdb.h" 1
# 44 "../../../../components/ble/host/linkdb.h"
#define LINKDB_H 
# 64 "../../../../components/ble/host/linkdb.h"
...
# 130 "../../../../components/ble/host/linkdb.h"
  ...
  extern uint8 _symrom_linkDB_Register( pfnLinkDBCB_t pFunc );
  ...
  extern linkDBItem_t *_symrom_linkDB_Find( uint16 connectionHandle );
  ...
  extern uint8 _symrom_linkDB_State( uint16 connectionHandle, uint8 state );
# 189 "../../../../components/ble/host/linkdb.h"
  extern uint8 linkDB_Authen( uint16 connectionHandle, uint8 keySize, uint8 mitmRequired );




  extern void _symrom_linkDB_PerformFunc( pfnPerformFuncCB_t cb );
...
# 47 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/profiles/Roles/peripheral.h" 1
# 46 "../../../../components/profiles/Roles/peripheral.h"
#define PERIPHERAL_H 
# 64 "../../../../components/profiles/Roles/peripheral.h"
...
# 269 "../../../../components/profiles/Roles/peripheral.h"
extern void GAPRole_Init( uint8 task_id );
# 285 "../../../../components/profiles/Roles/peripheral.h"
extern uint16 GAPRole_ProcessEvent( uint8 task_id, uint16 events );
# 48 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/profiles/Roles/gapbondmgr.h" 1
# 46 "../../../../components/profiles/Roles/gapbondmgr.h"
#define GAPBONDMGR_H 
# 56 "../../../../components/profiles/Roles/gapbondmgr.h"
# 1 "../../../../components/ble/include/gap.h" 1
# 42 "../../../../components/ble/include/gap.h"
#define GAP_H 
# 54 "../../../../components/ble/include/gap.h"
# 1 "../../../../components/ble/include/sm.h" 1
# 47 "../../../../components/ble/include/sm.h"
#define SM_H 
# 70 "../../../../components/ble/include/sm.h"
...
# 107 "../../../../components/ble/include/sm.h"
typedef struct
{
  osal_event_hdr_t hdr;
  uint8 newKey[16];
...
# 113 "../../../../components/ble/include/gap.h"
...
# 175 "../../../../components/ble/include/gap.h"
...
# 325 "../../../../components/ble/include/gap.h"
...
# 387 "../../../../components/ble/include/gap.h"
typedef struct
{
  osal_event_hdr_t hdr;
  uint8 opcode;
...
# 420 "../../../../components/ble/include/gap.h"
typedef struct
{
  uint8 taskID;
  uint8 mode;
...
# 501 "../../../../components/ble/include/gap.h"
typedef struct
{
  uint8 taskID;
  uint8 highDutyCycle;
...
# 529 "../../../../components/ble/include/gap.h"
typedef struct
{
  osal_event_hdr_t hdr;
  uint8 opcode;
...
# 577 "../../../../components/ble/include/gap.h"
typedef struct
{
  osal_event_hdr_t hdr;
  uint8 opcode;
...
# 661 "../../../../components/ble/include/gap.h"
typedef struct
{
  osal_event_hdr_t hdr;
  uint8 opcode;
...
# 720 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_DeviceInit( uint8 taskID,
                           ...
                           uint8 *pSRK,
                           uint32 *pSignCounter );
# 781 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_SetParamValue( gapParamIDs_t paramID, uint16 paramValue );
# 790 "../../../../components/ble/include/gap.h"
  extern uint16 _symrom_GAP_GetParamValue( gapParamIDs_t paramID );
# 811 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_ConfigDeviceAddr( uint8 addrType, uint8 *pStaticAddr );
# 821 "../../../../components/ble/include/gap.h"
  extern void _symrom_GAP_RegisterForHCIMsgs( uint8 taskID );
# 836 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_DeviceDiscoveryRequest( gapDevDiscReq_t *pParams );
# 847 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_DeviceDiscoveryCancel( uint8 taskID );
# 860 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_MakeDiscoverable( uint8 taskID, gapAdvertisingParams_t *pParams );
# 877 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_UpdateAdvertisingData( uint8 taskID, uint8 adType,
                                      uint8 dataLen, uint8 *pAdvertData );
# 889 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_EndDiscoverable( uint8 taskID );
# 901 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_ResolvePrivateAddr( uint8 *pIRK, uint8 *pAddr );
# 918 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_EstablishLinkReq( gapEstLinkReq_t *pParams );
# 932 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_TerminateLinkReq( uint8 taskID, uint16 connectionHandle, uint8 reason );
# 944 "../../../../components/ble/include/gap.h"
...
# 975 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_Authenticate( gapAuthParams_t *pParams, gapPairingReq_t *pPairReq );
# 989 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_TerminateAuth( uint16 connectionHandle, uint8 reason );
# 1007 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_PasskeyUpdate( uint8 *pPasskey, uint16 connectionHandle );
# 1024 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_PasscodeUpdate( uint32 passcode, uint16 connectionHandle );
# 1036 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_SendSlaveSecurityRequest( uint16 connectionHandle, uint8 authReq );
# 1053 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_Signable( uint16 connectionHandle, uint8 authenticated, smSigningInfo_t *pParams );
# 1071 "../../../../components/ble/include/gap.h"
  extern bStatus_t GAP_Bond( uint16 connectionHandle, uint8 authenticated,
                             smSecurityInfo_t *pParams, uint8 startEncryption );
# 1092 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_ParamsInit( uint8 taskID, uint8 profileRole );
# 1110 "../../../../components/ble/include/gap.h"
  extern void _symrom_GAP_SecParamsInit( uint8 *pIRK, uint8 *pSRK, uint32 *pSignCounter );
# 1121 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_PeriDevMgrInit( void );
# 1133 "../../../../components/ble/include/gap.h"
  extern bStatus_t _symrom_GAP_CentDevMgrInit( uint8 maxScanResponses );
# 1144 "../../../../components/ble/include/gap.h"
  extern void GAP_CentConnRegister( void );
# 1160 "../../../../components/ble/include/gap.h"
  extern void _symrom_GAP_Init( uint8 task_id );
# 1172 "../../../../components/ble/include/gap.h"
  extern uint16 _symrom_GAP_ProcessEvent( uint8 task_id, uint16 events );
# 57 "../../../../components/profiles/Roles/gapbondmgr.h" 2
# 78 "../../../../components/profiles/Roles/gapbondmgr.h"
...
# 166 "../../../../components/profiles/Roles/gapbondmgr.h"
...
# 107 "../../../../components/profiles/DevInfo/devinfoservice.h"
extern bStatus_t DevInfo_AddService( void );
# 123 "../../../../components/profiles/DevInfo/devinfoservice.h"
bStatus_t DevInfo_SetParameter( uint8 param, uint8 len, void *value );
# 134 "../../../../components/profiles/DevInfo/devinfoservice.h"
extern bStatus_t DevInfo_GetParameter( uint8 param, void *value );
# 50 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/profiles/Batt/battservice.h" 1
# 35 "../../../../components/profiles/Batt/battservice.h"
#define BATTSERVICE_H 
# 51 "../../../../components/profiles/Batt/battservice.h"
...
# 88 "../../../../components/profiles/Batt/battservice.h"
extern bStatus_t Batt_AddService( void );
# 99 "../../../../components/profiles/Batt/battservice.h"
extern void Batt_Register( battServiceCB_t pfnServiceCB );
# 114 "../../../../components/profiles/Batt/battservice.h"
extern bStatus_t Batt_MeasLevel( void );
# 51 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/profiles/HID/hiddev.h" 1
# 36 "../../../../components/profiles/HID/hiddev.h"
#define HIDDEV_H 
# 57 "../../../../components/profiles/HID/hiddev.h"
...
# 275 "../../../../components/profiles/HID/hiddev.h"
...
# 52 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../source/hidkbd.h" 1
# 38 "../source/hidkbd.h"
#define HIDEMUKBD_H 
# 54 "../source/hidkbd.h"
...
extern void hidCCSendReportKey( uint8 cmd, 
# 82 "../source/hidkbd.h" 3 4
                                          _Bool 
# 82 "../source/hidkbd.h"
                                               keyPressed);
# 53 "../../../../components/profiles/HID/hiddev.c" 2

# 1 "../../../../components/inc/global_config.h" 1
# 49 "../../../../components/inc/global_config.h"
...
#define LL_SWITCH 11
#define NON_ADV_CHANNEL_INTERVAL 12
...
#define ENH_CONN_CMP_EVENT_ALLOW 0x00000200
# 165 "../../../../components/inc/global_config.h"
extern uint32 *pGlobal_config;
# 55 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/ble/controller/ll_def.h" 1
# 56 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/profiles/HID/hidkbdservice.h" 1
# 36 "../../../../components/profiles/HID/hidkbdservice.h"
#define HIDKBDSERVICE_H 
# 55 "../../../../components/profiles/HID/hidkbdservice.h"
...
# 107 "../../../../components/profiles/HID/hidkbdservice.h"
 ...
 HID_REPORT_CC_IN_DECL_IDX,
 HID_REPORT_CC_IN_IDX,
 HID_REPORT_CC_IN_CCCD_IDX,
 HID_REPORT_REF_CC_IN_IDX,
...
# 150 "../../../../components/profiles/HID/hidkbdservice.h"
extern bStatus_t HidKbd_AddService(void);
# 57 "../../../../components/profiles/HID/hiddev.c" 2
# 1 "../../../../components/driver/include/log.h" 1
# 58 "../../../../components/profiles/HID/hiddev.c" 2
...
void HidDev_Init( uint8 task_id )
{
    ...
    _symrom_osal_set_event( hidDevTaskId, 0x0001 );
}
# 171 "../../../../components/profiles/HID/hiddev.c"
uint16 HidDev_ProcessEvent( uint8 task_id, uint16 events )
{
    ...
    if ( events & 0x8000 )
    {
        ...
        if ( (pMsg = _symrom_osal_msg_receive( hidDevTaskId )) != 0 )
        {
            hidDev_ProcessOSALMsg( (osal_event_hdr_t*)pMsg );

            _symrom_osal_msg_deallocate( pMsg );
        }
...
# 219 "../../../../components/profiles/HID/hiddev.c"
void HidDev_Report( uint8 id, uint8 type, uint8 len, uint8* pData )
{
  ...
  if( (gapRole_ConnectionHandle != 0xFFFF ) &&
   ( 3 == id ) && (hidReportCCInClientCharCfg & 0x0001 ) )
  {
   attHandleValueNoti_t Notify;
   Notify.handle = hidAttrTbl[8].handle;
   Notify.len = len;
   _symrom_osal_memcpy(Notify.value, pData, len);
   _symrom_GATT_Notification( gapRole_ConnectionHandle, &Notify, 0 );
  }

}
# 245 "../../../../components/profiles/HID/hiddev.c"
...
# 267 "../../../../components/profiles/HID/hiddev.c"
                         ...
                         uint8* pValue, uint8* pLen, uint16 offset, uint8 maxLen )
{
    ...
    if ( uuid == 0x2A4D ||
            ...
            uuid == 0x2A33 )
    {
# 299 "../../../../components/profiles/HID/hiddev.c"
    }
    else if ( uuid == 0x2A4B )
    {
        ...
        else
        {
            ...
            *pLen = (((maxLen) < ((hidReportMapLen - offset))) ? (maxLen) : ((hidReportMapLen - offset)));

            _symrom_osal_memcpy( pValue, pAttr->pValue + offset, *pLen );
        }
    }
    else if ( uuid == 0x2A4A )
    {
        *pLen = 4;
        _symrom_osal_memcpy( pValue, pAttr->pValue, 4 );
    }
    else if ( uuid == 0x2908 )
    {
        *pLen = 2;
        _symrom_osal_memcpy( pValue, pAttr->pValue, 2 );
    }
    else if ( uuid == 0x2A4E )
    {
        *pLen = 1;
...
# 351 "../../../../components/profiles/HID/hiddev.c"
...
# 382 "../../../../components/profiles/HID/hiddev.c"
    else if ( uuid == 0x2902 )
    {
        ...
        if ( status == 0x00 )
        {
   _symrom_osal_memcpy(pAttr->pValue,pValue,2);
...
# 431 "../../../../components/profiles/HID/hiddev.c"
static void hidDev_ProcessOSALMsg( osal_event_hdr_t* pMsg )
{
    switch ( pMsg->event )
    {
...
# 451 "../../../../components/profiles/HID/hiddev.c"
static void hidDevProcessGattMsg( gattMsgEvent_t* pMsg )
{
}
