# 1 "../../../../components/profiles/Roles/gapbondmgr.c"
...
# 1 "../../../../components/profiles/Roles/gapbondmgr.c"
# 49 "../../../../components/profiles/Roles/gapbondmgr.c"
# 1 "../../../../components/ble/include/bcomdef.h" 1
# 47 "../../../../components/ble/include/bcomdef.h"
#define BCOMDEF_H 
# 58 "../../../../components/ble/include/bcomdef.h"
...
# 59 "../../../../components/ble/include/bcomdef.h" 2
...
# 50 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 51 "../../../../components/profiles/Roles/gapbondmgr.c" 2
# 1 "../../../../components/ble/include/gap.h" 1
# 42 "../../../../components/ble/include/gap.h"
#define GAP_H 
# 52 "../../../../components/ble/include/gap.h"
# 1 "../../../../components/ble/include/bcomdef.h" 1
# 53 "../../../../components/ble/include/gap.h" 2
...
# 52 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 53 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 54 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 55 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 56 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 57 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 58 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 59 "../../../../components/profiles/Roles/gapbondmgr.c" 2
# 1 "../../../../components/driver/include/log.h" 1
# 60 "../../../../components/profiles/Roles/gapbondmgr.c" 2
...
# 86 "../../../../components/profiles/Roles/gapbondmgr.c"
uint8 gapBondMgr_TaskID;
# 111 "../../../../components/profiles/Roles/gapbondmgr.c"
...
# 122 "../../../../components/profiles/Roles/gapbondmgr.c"
bStatus_t GAPBondMgr_LinkEst( uint16 connHandle, uint8 role )
{
 if ( role == 0x04 &&
   0x02 == 0x02 )
 {
  _symrom_GAP_SendSlaveSecurityRequest( connHandle, (0x01 | 0x04 ) );
 }
  return ( 0x00 );
}
...
void GAPBondMgr_Register( gapBondCBs_t *pCB )
{
  ...
  _symrom_GAP_SetParamValue( 38, gapBondMgr_TaskID );


  GATTServApp_RegisterForMsg( gapBondMgr_TaskID );
}
# 153 "../../../../components/profiles/Roles/gapbondmgr.c"
uint8 GAPBondMgr_ProcessGAPMsg( gapEventHdr_t *pMsg )
{
 ...
 switch ( pMsg->opcode )
 {
  case 0x0B:
  {
   ...
   if ( _symrom_GAP_PasscodeUpdate( 0, pPkt->connectionHandle ) != 0x00 )
   {
    _symrom_GAP_TerminateAuth( pPkt->connectionHandle, 0x01 );
   }
  }
  break;
  ...
  case 0x0F:
  {
   ...
   if ( 0x02 == 0x00)
   {
    ...
    _symrom_GAP_TerminateAuth( pPkt->connectionHandle, 0x05 );
   }
   else
   {
    linkDBItem_t *pLinkItem = _symrom_linkDB_Find( pPkt->connectionHandle );
...
uint16 GAPBondMgr_ProcessEvent( uint8 task_id, uint16 events )
{
 ...
 if ( events & 0x8000 )
 {
  ...
  if ( (pMsg = _symrom_osal_msg_receive( gapBondMgr_TaskID )) != 0 )
  {
...
# 277 "../../../../components/profiles/Roles/gapbondmgr.c"
 uint8 gapBondMgr_ProcessOSALMsg( osal_event_hdr_t *pMsg )
{
 uint8 safeToDealloc = 1;
...
# 309 "../../../../components/profiles/Roles/gapbondmgr.c"
void gapBondMgrAuthenticate( uint16 connHandle, uint8 addrType,
                                    gapPairingReq_t *pPairReq )
{
 gapAuthParams_t params;
 _symrom_osal_memset(&params, 0,sizeof(gapAuthParams_t));
 params.connectionHandle = connHandle;
 params.secReqs.ioCaps = 0x03;
 params.secReqs.oobAvailable = 0;
 params.secReqs.authReq = (0x01 | 0x04 );
 params.secReqs.keyDist.sEncKey = 1;


 params.secReqs.maxEncKeySize = 16;
 ...
 _symrom_GAP_Authenticate( &params, pPairReq );
}
