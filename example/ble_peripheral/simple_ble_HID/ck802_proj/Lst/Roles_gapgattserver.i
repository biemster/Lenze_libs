# 1 "../../../../components/profiles/Roles/gapgattserver.c"
...
# 1 "../../../../components/profiles/Roles/gapgattserver.c"
# 47 "../../../../components/profiles/Roles/gapgattserver.c"
...
# 48 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 49 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 50 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 51 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 52 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 53 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 54 "../../../../components/profiles/Roles/gapgattserver.c" 2
...
# 55 "../../../../components/profiles/Roles/gapgattserver.c" 2
# 83 "../../../../components/profiles/Roles/gapgattserver.c"
static const ggsAppCBs_t *ggs_AppCBs = 0;
...
static const gattAttrType_t gapService = { 2, _symrom_gapServiceUUID };


static uint8 deviceNameCharProps = 0x02;


static uint8 deviceName[(5+1)+1] = { 0 };


static uint8 appearanceCharProps = 0x02;


static uint16 appearance = 0x0000;
...
static gattAttribute_t gapAttrTbl[] =
{

  {
...

    {
      ...
      {
        { 2, _symrom_appearanceUUID },
        0x01,
        0,
        (uint8 *)&appearance
      }
};
# 162 "../../../../components/profiles/Roles/gapgattserver.c"
...
# 193 "../../../../components/profiles/Roles/gapgattserver.c"
bStatus_t GGS_AddService( )
{
 uint8 status = 0x00;

 status = GATTServApp_RegisterService( gapAttrTbl, ( sizeof( gapAttrTbl ) / sizeof( gattAttribute_t ) ),
                                    &gapServiceCBs );

 return ( status );
}
# 217 "../../../../components/profiles/Roles/gapgattserver.c"
void GGS_RegisterAppCBs( ggsAppCBs_t *appCallbacks )
{
  ggs_AppCBs = appCallbacks;
}
# 236 "../../../../components/profiles/Roles/gapgattserver.c"
static uint8 ggs_ReadAttrCB( uint16 connHandle, gattAttribute_t *pAttr,
                             uint8 *pValue, uint8 *pLen, uint16 offset, uint8 maxLen )
{
  uint16 uuid;
  ...
  if ( pAttr->type.len == 2 )
  {
    ...
    uuid = ((uint16)(((pAttr->type.uuid[0]) & 0x00FF) + (((pAttr->type.uuid[1]) & 0x00FF) << 8)));
    switch ( uuid )
    {
      case 0x2A00:
        {
   ...
   {
    _symrom_LL_ReadBDADDR(publicAddr);
    _symrom_osal_memcpy(publicAddr,publicAddr,6 );
   }
   ...
   _symrom_osal_memcpy(&attDeviceName[10],AddrStr,(6<<1) );

    uint8 len = sizeof(attDeviceName);

          *pLen = len;
          (void) _symrom_osal_memcpy( pValue, attDeviceName, len );
        }
        break;
      ...
      case 0x2A01:
        {
          ...
          *pLen = 2;
          pValue[0] = ((0x03C4) & 0xFF);
          pValue[1] = (((0x03C4) >> 8) & 0xFF);
        }
        break;
