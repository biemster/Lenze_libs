# 1 "../../../../components/driver/source/pwrmgr.c"
...
# 1 "../../../../components/driver/source/pwrmgr.c"
# 32 "../../../../components/driver/source/pwrmgr.c"
...
# 33 "../../../../components/driver/source/pwrmgr.c" 2
...
# 34 "../../../../components/driver/source/pwrmgr.c" 2
...
# 35 "../../../../components/driver/source/pwrmgr.c" 2
...
# 37 "../../../../components/driver/source/pwrmgr.c" 2
...
# 62 "../../../../components/driver/include/pwrmgr.h"
typedef struct
{
    gpio_pin_e pin;
...
# 39 "../../../../components/driver/source/pwrmgr.c" 2

# 1 "../../../../components/driver/include/gpio.h" 1
# 41 "../../../../components/driver/source/pwrmgr.c" 2
# 1 "../../../../components/driver/include/log.h" 1
# 42 "../../../../components/driver/source/pwrmgr.c" 2
...
void _symrom_clk_gate_enable(MODULE_e module);
void _symrom_clk_reset(MODULE_e module);
# 43 "../../../../components/driver/source/pwrmgr.c" 2
...
# 44 "../../../../components/driver/source/pwrmgr.c" 2

extern uint32_t _symrom_s_config_swClk0;
extern uint32_t _symrom_s_config_swClk1;
...
{
    do{((AP_WDT_TypeDef *) ((0x40000000UL) + 0x2000))->CRR = 0x76;}while(0);
    _symrom_osal_pwrmgr_powerconserve0();
}
int hal_pwrmgr_init(void)
{
 ...
 _symrom_pwrmgr_config(2);


    _symrom_pwrmgr_init();

    _symrom_s_config_swClk0 = (((1ul << (0)))|((1ul << (4)))|((1ul << (7)))|((1ul << (8)))|((1ul << (13)))|((1ul << (19))));
    _symrom_s_config_swClk1 = ( ((1ul << (3))) |((1ul << (4))) |((1ul << (9))) |((1ul << (21)))|((1ul << (22)))|((1ul << (23)))|((1ul << (24)))|((1ul << (6))));




    if(((((AP_WDT_TypeDef *) ((0x40000000UL) + 0x2000))->CR & 0x01)))
        _symrom_JUMP_FUNCTION_SET(43,(uint32_t)&osal_idle_task);
