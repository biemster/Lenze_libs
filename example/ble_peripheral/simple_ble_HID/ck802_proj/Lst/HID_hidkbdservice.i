# 1 "../../../../components/profiles/HID/hidkbdservice.c"
...
# 1 "../../../../components/profiles/HID/hidkbdservice.c"
# 40 "../../../../components/profiles/HID/hidkbdservice.c"
...
# 41 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 42 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 43 "../../../../components/profiles/HID/hidkbdservice.c" 2
# 1 "../../../../components/ble/include/att.h" 1
# 49 "../../../../components/ble/include/att.h"
#define ATT_H 
# 59 "../../../../components/ble/include/att.h"
# 1 "../../../../components/ble/include/bcomdef.h" 1
# 60 "../../../../components/ble/include/att.h" 2
...
# 44 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 45 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 46 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 47 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 48 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 49 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 50 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 51 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 52 "../../../../components/profiles/HID/hidkbdservice.c" 2
...
# 53 "../../../../components/profiles/HID/hidkbdservice.c" 2
# 71 "../../../../components/profiles/HID/hidkbdservice.c"
const uint8 hidServUUID[2] =
{
    ((0x1812) & 0xFF), (((0x1812) >> 8) & 0xFF)
};


const uint8 hidInfoUUID[2] =
{
 ((0x2A4A) & 0xFF), (((0x2A4A) >> 8) & 0xFF)
};


const uint8 hidReportMapUUID[2] =
{
 ((0x2A4B) & 0xFF), (((0x2A4B) >> 8) & 0xFF)
};


const uint8 hidReportUUID[2] =
{
 ((0x2A4D) & 0xFF), (((0x2A4D) >> 8) & 0xFF)
};


const uint8 hidProtocolModeUUID[2] =
{
 ((0x2A4E) & 0xFF), (((0x2A4E) >> 8) & 0xFF)
};
# 145 "../../../../components/profiles/HID/hidkbdservice.c"
static const uint8 hidInfo[4] =
{
...
static const gattAttrType_t hidService = { 2, hidServUUID };


static uint8 hidInfoProps = 0x02;


static uint8 hidReportMapProps = 0x02;
# 210 "../../../../components/profiles/HID/hidkbdservice.c"
static uint8 hidProtocolModeProps = 0x02 | 0x04;
uint8 hidProtocolMode = 0x01;
# 257 "../../../../components/profiles/HID/hidkbdservice.c"
static uint8 hidReportFeatureProps = 0x02 | 0x08;
static uint8 hidReportFeature;


static uint8 hidReportRefFeature[2] = { 0, 3 };




static uint8 hidReportRefCCIn[2] = { 3, 1 };


static uint8 hidReportCCInProps = 0x02 | 0x10;
static uint8 hidReportCCIn;
uint16 hidReportCCInClientCharCfg = 0x0000;
# 281 "../../../../components/profiles/HID/hidkbdservice.c"
gattAttribute_t hidAttrTbl[] =
{

    {
        { 2, _symrom_primaryServiceUUID },
        0x01,
        0,
        (uint8*)& hidService
    },
...
# 326 "../../../../components/profiles/HID/hidkbdservice.c"
    {
        { 2, _symrom_characterUUID },
        0x01,
        0,
...
# 523 "../../../../components/profiles/HID/hidkbdservice.c"
    {
        { 2, _symrom_characterUUID },
        0x01,
        0,
...
# 591 "../../../../components/profiles/HID/hidkbdservice.c"
...
# 610 "../../../../components/profiles/HID/hidkbdservice.c"
bStatus_t HidKbd_AddService( void )
{
    uint8 status = 0x00;


    status = GATTServApp_RegisterService( hidAttrTbl, ( sizeof( hidAttrTbl ) / sizeof( gattAttribute_t ) ), &hidKbdCBs );
    return ( status );
}
